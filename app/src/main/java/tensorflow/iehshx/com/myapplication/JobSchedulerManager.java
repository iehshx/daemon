...
public class JobSchedulerManager {  
    ...
    public void startJobScheduler(){  
        ...
        if(CustomJobService.isJobServiceAlive() || isBelowLOLLIPOP()){
            return;  
        }  
        // 构建JobInfo对象，传递给JobSchedulerService  
        JobInfo.Builder builder = new JobInfo.Builder(JOB_ID,new ComponentName(mContext, CustomJobService.class));
        // 设置每3秒执行一下任务  
